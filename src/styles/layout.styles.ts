export const layoutStyles = {
  ...
  headerContent: 'flex items-center px-4 h-20',
  mainContent: 'flex flex-1 overflow-hidden relative',
  sidebar: (isOpen: boolean) =>`bg-white shadow-2xl transition-all duration-300 ease-in-out z-40 ${isOpen ? 'w-80 ' : 'w-0'} overflow-hidden`,
  sidebarContent: 'w-80 h-full flex flex-col !px-4 gap-6 !py-4 bg-gray-20',
