          ...
          <div className={`${layoutStyles.headerContent} flex items-center justify-between px-6 py-3`}>
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-xl font-semibold text-gray-800 hidden sm:block">Maps</h1>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <button
                ...
                className={`${buttonStyles.icon} ${editorActive ? 'bg-green-100 text-green-600' : ''}`}
              ...
              <button className={`${buttonStyles.icon} hidden md:flex`} aria-label="Settings">
