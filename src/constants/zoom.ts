...
export const boundaries_coarse_zoom: zoom_range = { min: 5, max: 16 }
...
export const waterways_zoom: zoom_range = { min: 16, max: 20 }
...
export const land_cover_coarse_zoom: zoom_range = { min: 11, max: 13 }