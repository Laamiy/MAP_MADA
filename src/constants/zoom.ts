...
// Roads
export const roads_zoom: zoom_range = { min: 13, max: 20 }
...
// Places
export const places_zoom: zoom_range = { min: 13, max: 17 }
...
export const esa_vegetation_raw_zoom: zoom_range = { min: 3, max: 9.5 }
