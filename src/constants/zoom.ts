...
export const world_countries_name_zoom : zoom_range = {min: 2, max : 6 }
export const world_ocean_110m_zoom: zoom_range = { min: 0, max: 20 }
export const world_countries_110m_zoom: zoom_range = { min: 0, max: 5 }
export const world_countries_50m_zoom: zoom_range = { min: 0, max: 20 }
export const boundaries_coarse_zoom: zoom_range = { min: 5, max: 15 }
export const boundaries_coarse_name_zoom: zoom_range = { min: 5, max: 16}
...
export const waterways_zoom: zoom_range = { min: 14, max: 20 }
export const landuse_zoom: zoom_range = { min:10 , max: 20 }
export const roads_low_zoom: zoom_range = { min: 1, max: 20 }
...
export const places_zoom: zoom_range = { min: 14, max: 20 }
export const pois_zoom: zoom_range = { min: 5, max: 20 }
...
export const esa_vegetation_raw_zoom: zoom_range = { min: 0, max: 11}
export const water_polygons_labels_zoom: zoom_range = { min: 14, max: 20 }
export const land_cover_zoom: zoom_range = { min: 13, max: 18 }
export const land_cover_coarse_zoom: zoom_range = { min: 10, max: 13 }
